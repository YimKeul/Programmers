...
public class Main {
	public static void main(String args[]) throws Exception {
		...
		String test[] = {"F000000.txt"}; 
		String input_1[] = {"img12.png", "img10.png", "img02.png", "img1.png", "IMG01.GIF", "img2.JPG"};
		//System.out.println(so.solution(test));
		String input_2[] = {"F-5 Freedom Fighter", "B-50 Superfortress", "A-10 Thunderbolt II", "F-14 Tomcat"};
		String input_3[] = {"muzi1.txt","MUZI1.txt","muzi001.txt","muzi1.TXT"};
		System.out.println(so.solution(input_1));
		
		
	}
}

//3 4 12 13 14  15 19 20
